...
{
	DisableInputControl();
	GetWorldTimerManager().SetTimer(TimerHandle_Stun, this, &ACharacterBase::EnableInputControl, StunDuration, false);
}

void ACharacterBase::CancelAllAbilities()
{
	if (this->AbilitySystemComp)
	{
		this->AbilitySystemComp->CancelAllAbilities();
	}
}
